module Rubyvis
  ...
  class Panel < Bar
    ...
    attr_accessor_dsl :transform, :overflow, :canvas, :classg, :font_size, :font_family, :fill, :stroke, :stroke_width
    ...
    def self.defaults
      Panel.new.mark_extend(Bar.defaults).fill_style(nil).overflow('visible').left(0).right(0).bottom(0).top(0)
    end
