class Rubyvis::Mark
  ...
  def self.mark_method(name, mark) #:nodoc:
    define_method(name) do |*args,&block|
      ...
      a=base.add(mark)# DDD per il rule, area chiama il Panel.add # BOO aggiunto il base
      #mark == "group" ? a=base.add(mark, base) : a=base.add(mark)
      if block
  ...
  mark_method :group, Rubyvis::Group
