module Rubyvis
  ...
  class Wedge < Mark
    ...
    attr_accessor_dsl :start_angle, :end_angle, :angle, :inner_radius, :outer_radius, :line_width, [:stroke_style, lambda {|d| Rubyvis.color(d)}], [:fill_style, lambda {|d| Rubyvis.color(d)}], :fill_rule, :shape_rendering, :transform, :fill, :fill_opacity, :stroke, :stroke_opacity, :stroke_width, :centroid
